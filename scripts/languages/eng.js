const eng = {
  ...
  */
  ...
  sub_work_002:"Computer and Mathematical (programmers, web designers, software analysts)",
  sub_work_003:"Architecture and Engineering (architects, engineers)",
  sub_work_004:"Life, Physical, and Social Science (historians, geologists, psychologists, anthropologists)",
  sub_work_005:"Community and Social Services (social workers, public health workers)",
  sub_work_006:"Legal (lawyers, judges)",
  sub_work_007:"Education, Training, and Library (educators, librarians)",
  sub_work_008:"Arts, Design, Entertainment, Sports, Media (interior designers, florists, fashion designers, actors, musicians, producers, coaches, photographers, public relations specialists)",
  sub_work_009:"Healthcare Practitioner and Technical (doctors, dentists, speech therapists, surgeons)",
  sub_work_010:"Healthcare Support",
  sub_work_011:"Protective Service (firefighters, police officers)",
  sub_work_012:"Food Preparation and Serving Related (chefs, bartenders, waiters)",
  sub_work_013:"Bldg & Grounds Cleaning, Maintenance (custodians and building maintenance workers, pest control workers)",
  sub_work_014:"Personal Care and Service (hairdressers, beauticians)",
  sub_work_015:"Sales and Related Occupations (cashiers, models, insurance agents)",
  sub_work_016:"Office and Administrative Support (secretaries, customer service representatives)",
  sub_work_017:"Farming, Fishing, and Forestry (forest and nature conservation workers, fishermen, agricultural workers)",
  sub_work_018:"Construction and Extraction (carpenters, building inspectors, insulation workers, ceiling, wall, floor installers)",
  sub_work_019:"Installation, Maintenance, and Repair (auto service technicians and mechanics, electrical and electronic installers and repairers, general maintenance and repair workers)",
  sub_work_020:"Production (food processing workers, metal and plastic equipment workers)",
  sub_work_021:"Transportation and Material Moving (bus drivers, conductors, taxi drivers)",
...
<h2>Version v4.3</h2>
<ol>
<li>Fixed an error with the calculation of METs for subactivities with the unit "Hours per month".</li>
</ol>
<h2>Version v4.2</h2>
<ol>
...
<li>Made it so that the "About the program" button is always in the lower right corner when scrolling the screen.</li>
</ol>
<h2>Version v3.0</h2>
<ol>
